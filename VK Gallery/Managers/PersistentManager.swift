...
// TODO: PersistentManager по названии является общей точкой доступа к базе данных, неважно
// какие данные ты захочешь получить, фото, видео, данные авторизации и что угодно. Но ты сделал так,
// будто общий менеджер должен отвечать за получение фото.
// Подумай как правильно это исправить
